...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://localhost:5173", "https://localhost:3000", "https://packwise-frontend-580624387675.europe-southwest1.run.app", "https://packwise-frontend-jk6n3yy7fa-no.a.run.app"],
